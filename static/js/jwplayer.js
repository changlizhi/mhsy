"undefined" == typeof jwplayer && (jwplayer = function (f) {
  ...
  var f = {}, c = Array.prototype, k = Object.prototype, d = c.slice, e = c.concat, b = k.toString, h = k.hasOwnProperty, n = c.map, a = c.forEach, g = c.filter, m = c.some, p = c.indexOf, k = Array.isArray, l = Object.keys, j = function (a) {
    ...
    if (null == r)return r;
    if (a && r.forEach === a) r.forEach(g, b); else if (r.length === +r.length)for (var d = 0, m = r.length; d < m; d++) {
      if (g.call(b, r[d], d, r) === f)return
    } else for (var c = j.keys(r), d = 0, m = c.length; d < m; d++)if (g.call(b, r[c[d]], c[d], r) === f)return;
    return r
  };
  ...
  j.indexOf = function (a, g, b) {
    if (null == a)return -1;
    var d = 0, m = a.length;
    if (b)if ("number" == typeof b) d = 0 > b ? Math.max(0, m + b) : b; else return d = j.sortedIndex(a, g), a[d] ===
    g ? d : -1;
  ...
  d.repo = function () {
    var a = "http://www.huawei.com/minisite/ubbf2014/en/assets/";
    try {
  ...
  d.ajax = function (a, b, c, e) {
    ...
    if (a && 0 <= a.indexOf("://") && a.split("/")[2] !== window.location.href.split("/")[2] && d.exists(window.XDomainRequest)) h = new window.XDomainRequest, h.onload = k(h, a, b, c, e), h.ontimeout = h.onprogress = function () {
    }, h.timeout = 5E3; else if (d.exists(window.XMLHttpRequest)) {
  ...
  f.touch = function (d) {
    ...
    function h(a, b) {
      ...
      if (!c)return null;
      var d = n.getBoundingClientRect(), c = {
        type: a,
        target: n,
      ...
      this.removeEventListener = function (d, a) {
        ...
        if (b[d]) {
          try {
            ...
            for (g = 0; g < b[d].length; g++)if (b[d][g].listener.toString() === a.toString()) {
              b[d].splice(g, 1);
              break
            }
          } catch (e) {
  ...
  h.parseGroup = function (f, a) {
    var g, m, p = [];
    for (m = 0; m < b(f); m++)if (g = f.childNodes[m], "media" == g.prefix && d(g))switch (d(g).toLowerCase()) {
      case "content":
  ...
  f.rssparser.parse = function (d) {
    for (var a = [], g = 0; g < b(d); g++) {
      var f = e(d, g);
      if ("channel" == h(f).toLowerCase())for (var k = 0; k < b(f); k++) {
        var l = e(f, k);
  ...
  f.playlist.loader = function () {
    function e(a) {
      try {
        ...
        if ("rss" !== d.localName(a)) h("Not a valid RSS feed"); else {
    ...
    function n() {
      if (!y) {
        ...
        if (!x)if (e.isString(c)) w =
          ...
          x = !1;
          m(a)
        }), x = !0, w.load(j.playlist); else if (u.getStatus() === k.loaderstatus.COMPLETE) {
          for (c = 0; c < j.modes.length; c++) {
            var g = j.modes[c], r = g.type;
            if (r && b[r]) {
              var l = k.extend({}, j), g = new b[r](D, g, l, u, h);
              if (g.supportsConfig())return g.addEventListener(d.ERROR, a), g.embed(), k.css("object.jwswf, .jwplayer:focus", {outline: "none"}), k.css(".jw-tab-focus:focus",
  ...
  (f.embed.config = function (b) {
    ...
    c(b);
    k = b.aspectratio;
    if ("string" !== typeof k || !d.exists(k)) e = 0; else {
      var a = k.indexOf(":");
  ...
  f.embed.download = function (d, e, b) {
    ...
    e = e.logo ? e.logo : {prefix: c.repo(), file: "/sattic/img/logo.png", margin: 10};
    var l, j, t, v, r, q;
    j = n.playlist;
    n = ["mp4", "aac", "mp3"];
    if (j &&
  ...
  (f.embed.flash = function (b, h, n, a, g) {
    ...
    this.embed = function () {
      n.id = g.id;
      if (10 > t)return j.sendEvent(k.ERROR, {message: "Flash version must be 10.0 or greater"}), !1;
      var e, f, q = g.config.listbar, u =
        c.extend({}, n);
      if (b.id + "_wrapper" === b.parentNode.id) e = document.getElementById(b.id + "_wrapper"); else {
    ...
    this.supportsConfig = function () {
      if (t)if (n) {
        ...
        try {
          ...
          for (var b = 0; b < a.length; b++)if (a[b].file && e(a[b].file, a[b].type))return !0
        } catch (d) {
        }
      } else return !0;
      return !1
  ...
  f.embed.html5 = function (e, b, h, k, a) {
    ...
    p.supportsConfig = function () {
      if (f.vid.canPlayType)try {
        ...
        for (var a = h.playlist[0].sources, b = 0; b < a.length; b++)if (f.embed.html5CanPlay(a[b].file, a[b].type, h.androidhls))return !0
      } catch (d) {
      }
      return !1
    }
  ...
  d.controller = function (a, g) {
    ...
    function J(c) {
      if ("state" === c.type) {
        if (A && (c.diff.newstate || c.diff.position)) A.destroy(), A = null, g.setVideoProvider(B), g.sendEvent(b.JWPLAYER_CAST_AD_CHANGED, {done: !0});
    ...
    var z = null, N = {available: !1, active: !1, deviceName: ""}, I = {
      volume: null,
      mute: null
    }, O = e.getAbsolutePath(f.location.href), G, B = null, A = null, L = null;
    m = g.volume;
    p = g.mute;
    var H = null, R = null;
    G = e.extend({}, n, g.cast);
  ...
  function (f, c) {
    ...
    window.chrome = c;
    var a = f.cast, g = f.utils, m = f.events, p, l = 0, j = null, t = g.extend({
  ...
  f.api = function (k) {
    ...
    q.resize = function (a, b) {
      if ("flash" !== q.renderingMode) r("jwResize", a, b); else {
  ...
  f.api.instream = function (e, b) {
    ...
    l.dispatchEvent = function (a, b) {
      var c = m[a];
      if (c)for (var c = c.slice(0), d = k.translateEventResponse(a, b[1]), e = 0; e < c.length; e++) {
        var f = c[e];
