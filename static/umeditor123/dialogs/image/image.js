...
//                }
  ...
  var Upload = {
    ...
    '<input style=\"filter: alpha(opacity=50);\" class="edui-image-file" type="file" hidefocus name="upload" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
    '</form>' +
    ...
    submit: function (callback) {
      ...
      var me = this,
        input = $('<input style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="upload" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">'),
        input = input[0];
