...
func load_beego_json() {
	...
	Bgo_json.Ying_wen = json_obj["Ying_wen"]
	Bgo_json.Zhong_wen = json_obj["Zhong_wen"]
	Bgo_json.Chanpin_first = json_obj["Chanpin_first"]
	Bgo_json.Chanpin_second = json_obj["Chanpin_second"]
	Bgo_json.Chanpin_third = json_obj["Chanpin_third"]
	Bgo_json.Xinwen_tupian1 = json_obj["Xinwen_tupian1"]
	Bgo_json.Xinwen_tupian2 = json_obj["Xinwen_tupian2"]
	Bgo_json.Xinwen_wenzi1 = json_obj["Xinwen_wenzi1"]
	Bgo_json.Xinwen_wenzi2 = json_obj["Xinwen_wenzi2"]
	Bgo_json.Xinwen_wenzi3 = json_obj["Xinwen_wenzi3"]
	Bgo_json.Xinxi_first = json_obj["Xinxi_first"]
	Bgo_json.Xinxi_second_left = json_obj["Xinxi_second_left"]
	Bgo_json.Xinxi_second_right_up = json_obj["Xinxi_second_right_up"]
	Bgo_json.Xinxi_second_right_down = json_obj["Xinxi_second_right_down"]
	Bgo_json.Xinxi_third_left = json_obj["Xinxi_third_left"]
	Bgo_json.Xinxi_third_right = json_obj["Xinxi_third_right"]
}
